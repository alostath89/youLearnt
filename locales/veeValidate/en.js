export default {
    ...
    messages: {
        ...
        is: 'This field not matching the previously entered value',
        dateComparison: 'This field must be grater than date {1}',
        timeComparison: 'This field must be grater than time {1}',
        minYear: 'This field must be grater or equal to year {0}',
        systemPassword: 'At least 6 characters (1 Digit / 1 Capital letter / 1 Small letter / 1 Special character)',
    },
}
